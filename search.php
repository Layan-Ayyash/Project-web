...
include("db.php.inc.php"); 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['show_checked'])) {
        $checkedCars = isset($_POST['checked_cars']) ? $_POST['checked_cars'] : [];

        $sql = "SELECT car_id, model, make, type, price_per_day, fuel_type, image1
                FROM cars 
                WHERE type = :car_type 
                AND price_per_day BETWEEN :price_min AND :price_max
                AND car_id IN (" . implode(',', $checkedCars) . ")";
...
<div class="container">
    ...
    <main>
        ...
        <form method="GET" action="search.php">
            ...
            <input type="text" id="pickup_location" name="pickup_location" value="Birzeit"><br><br>
        ...
        <form method="POST" action="search.php">
            <input type="hidden" name="show_checked" value="1">
            <table>
                <thead>
                    <tr>
